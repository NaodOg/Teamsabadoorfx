...
export const AnimatedMarqueeHero: React.FC<AnimatedMarqueeHeroProps> = ({
  ...
  return (
    <section className={cn("relative w-full h-screen overflow-hidden bg-black", className)}>
      {/* Content Area - taking upper portion of screen to leave space for images at bottom */}
      <div className="absolute top-0 left-0 w-full h-1/2 flex flex-col items-center justify-center text-center px-4 z-10">
        {/* Tagline */}
        <motion.div
          initial="hidden"
          animate="show"
        ...
        >
          <ActionButton onClick={ctaOnClick}>{ctaText}</ActionButton>
        </motion.div>
      </div>
